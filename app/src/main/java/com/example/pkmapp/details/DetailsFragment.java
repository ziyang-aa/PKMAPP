...
import com.example.pkmapp.R; import com.example.pkmapp.data.*; import com.example.pkmapp.databinding.FragmentDetailsBinding; import com.example.pkmapp.record.MoneyParser;
...
public final class DetailsFragment extends Fragment {
 ...
 @Nullable @Override public View onCreateView(@NonNull LayoutInflater i,@Nullable ViewGroup p,@Nullable Bundle s){binding=FragmentDetailsBinding.inflate(i,p,false);return binding.getRoot();}
